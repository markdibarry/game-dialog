# <a id="GameCore_Dialog_Error"></a> Error `class`
...
### <a id="GameCore_Dialog_Error__ctor_System_Int32_System_Int32_System_Int32_System_String_"></a> Error\(int, int, int, string\)
...
### <a id="GameCore_Dialog_Error_End"></a> End
...
### <a id="GameCore_Dialog_Error_Line"></a> Line
...
### <a id="GameCore_Dialog_Error_Message"></a> Message
...
### <a id="GameCore_Dialog_Error_Start"></a> Start
