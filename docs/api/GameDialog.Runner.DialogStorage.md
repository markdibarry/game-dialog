# <a id="GameDialog_Runner_DialogStorage"></a> DialogStorage `class`
...
### <a id="GameDialog_Runner_DialogStorage_ClearLocalStorage"></a> ClearLocalStorage\(\)
...
### <a id="GameDialog_Runner_DialogStorage_ContainsKey_System_String_"></a> ContainsKey\(string\)
...
### <a id="GameDialog_Runner_DialogStorage_SetValue_System_ReadOnlySpan_System_Char__System_String_"></a> SetValue\(ReadOnlySpan<char\>, string\)
...
### <a id="GameDialog_Runner_DialogStorage_SetValue_System_ReadOnlySpan_System_Char__System_Single_"></a> SetValue\(ReadOnlySpan<char\>, float\)
...
### <a id="GameDialog_Runner_DialogStorage_SetValue_System_ReadOnlySpan_System_Char__System_Boolean_"></a> SetValue\(ReadOnlySpan<char\>, bool\)
...
### <a id="GameDialog_Runner_DialogStorage_TryGetValue__1_System_ReadOnlySpan_System_Char____0__"></a> TryGetValue<T\>\(ReadOnlySpan<char\>, out T?\)
