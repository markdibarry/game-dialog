...
public partial class DialogGenerator : IIncrementalGenerator
{
            ...
            .CreateSyntaxProvider(
                ...
                transform: static (ctx, _) =>
                {
                    ...
                    bool hasAttr = symbol.GetAttributes()
                        .Any(a => a.AttributeClass?.ToDisplayString() == "GameDialog.Runner.DialogBridgeAttribute");
        ...
        (Compilation Comp, ImmutableArray<INamedTypeSymbol?> Classes) data)
    {
        ...
        _bridgeAttrType = compilation.GetTypeByMetadataName("GameDialog.Runner.DialogBridgeAttribute");
